...
class UserFinder
{
    ...
    //vérifie que l'utilisateur existe dans la table
    ...
    //vérifie le mot de passe en fonction du nom d'utilisateur renseigné
    ...
    //Récupère les info de la personne qui se connecte
